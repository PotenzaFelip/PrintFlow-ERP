...
pyinstaller --noconfirm --onedir --windowed --add-data "feats;feats" --add-data "stls_projeto;stls_projeto" --collect-submodules "pyvista" --collect-submodules "pyvistaqt" --hidden-import "PyQt5" --name "PrintFlow_ERP" main.py
```
